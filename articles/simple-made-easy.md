...
* **Script: https://github.com/matthiasn/talk-transcripts/blob/master/Hickey_Rich/SimpleMadeEasy.md**
* **Speaker: Rich Hickey**
...
- 단순성(Simplicity)은 신뢰성(reliability)의 전제조건이다. (다익스트라)
- 좋은 시스템을 만드려면 단순한 시스템을 만들어야 합니다. 하지만 많은 사람들이 그 부분에 대해 충분히 집중하지 않고 있다고 생각합니다.

![00:01:21 Word Origins](SimpleMadeEasy/00.01.21.jpg)

So the first word is simple. 
And the roots of this word are sim and plex, and that means one fold or one braid or twist.
And that characteristic about being about one literally fold or twist, of course one twist, 
what's one twist look like? No twists, right, actually. 
